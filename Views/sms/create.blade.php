                ...
                <div class="card">
                    <div class="card-body">
                        <section>
                            ...
                            @endif
                            <div class="well">
                                {!! Form::open(['class' => 'form-floating', 'files' => true, 'url' => route('administrator.schedule.store.sms')]) !!}
                                ...
                                <div class="form-group {!! $errors->has('content') ? ' has-error' : '' !!}">
                                    ...
                                    {!! Form::text('content', old('content'), ['class' => 'form-control', 'maxlength' => '800', 'id' => 'content']) !!}
                                </div>
